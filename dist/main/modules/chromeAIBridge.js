...
exports.ChromeAIBridge = void 0;
exports.getChromeAIBridge = getChromeAIBridge;
exports.cleanupChromeAIBridge = cleanupChromeAIBridge;
const electron_1 = require("electron");
const http_1 = __importDefault(require("http"));
class ChromeAIBridge {
    constructor() {
        this.server = null;
        this.port = 3001;
...
exports.ChromeAIBridge = ChromeAIBridge;
// Singleton
let bridgeInstance = null;
function getChromeAIBridge() {
    if (!bridgeInstance) {
        bridgeInstance = new ChromeAIBridge();
    }
    return bridgeInstance;
}
function cleanupChromeAIBridge() {
    if (bridgeInstance) {
        bridgeInstance.stop();
        bridgeInstance = null;
    }
