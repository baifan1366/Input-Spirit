...
exports.articleWriterPlugin = void 0;
exports.articleWriterPlugin = {
    metadata: {
        name: 'article-writer',
        version: '1.0.0',
    ...
    async run(context) {
        ...
        try {
            // Use Writer API
            const article = await context.ai.write(`Write a well-structured, informative article about: ${topic}. 
