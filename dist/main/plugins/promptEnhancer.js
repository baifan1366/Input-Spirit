...
exports.promptEnhancerPlugin = void 0;
exports.promptEnhancerPlugin = {
    metadata: {
...
Return only the enhanced prompt without explanations.`,
            ...
            const enhancedPrompt = await session.prompt(`Enhance this prompt to be more specific and effective:\n\n"${userPrompt}"`);
